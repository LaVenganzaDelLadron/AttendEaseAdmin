        ...
        <div class="relative z-10 w-full max-w-md">
            ...
            <div class="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl">
                ...
                <form @submit.prevent="signUp" class="space-y-5">
                    ...
                    <button
                        type="submit"
                        class="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white font-semibold py-3 rounded-lg transition transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-0 mt-6"
                    >
                        Create Account
                    </button>
                </form>
                ...
                <p class="text-center text-slate-300 text-sm">
                    ...
                    <Link href="/login" class="text-indigo-400 hover:text-indigo-300 font-semibold transition">
                        Sign in here
                    </Link>
                </p>
            </div>
